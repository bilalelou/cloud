...
<html lang="en" dir="ltr">
	<head>
		...
		<meta content="E-impact Pro Deliverability" name="description">
		...
		<!-- Title -->
		<title>E-impact Pro Cloud Servers</title>
				...
				<div class="container text-center">
					<div class="row">
						...
						<div class="col-md-6 d-none d-md-flex align-items-center">
							<img src="{{ asset('assets/images/png/e1.png') }}" style="max-width: 60%" alt="img">
						</div>
					</div>
				</div>
			</div>
