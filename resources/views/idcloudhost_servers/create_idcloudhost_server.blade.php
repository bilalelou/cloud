...
@section('content')
                ...
                <div id="get_geos_card">
                    ...
                    <div id="get_geos_body" class="card-body">
                        <div class="col-12">
                                ...
                                <div class="card-footer d-flex justify-content-between">
                                    ...
                                    <div class="d-flex justify-content-end" style="gap: 10px">
                                        ...
                                        <button id="check_spamhaus" class="btn btn-warning card-options"
                                            style="display: none" onclick="checkSpamhaus()">Check Spamhaus</button>
                            ...
                            <div id="serverCreate" style="display: none">
    ...
    <script>
        ...
        //         success: function(response) {
        //             console.log("Request successful:", response.responses);
        //             console.log("Request succsful:", response.responses);
        //             console.log("Request successful:", response.responsesIps);
        ...
        //                 console.log("Data received:", response.responses);
    ...
    //     <td>${server.osSystem}</td>
    //     <td>
    //         <button class="btn btn-primary" onclick="handleAction('${server.action}')">
    //             ${server.action}
    //         </button>
    //     </td>
    // `;
