    ...
    <script>
                    ...
                    if (response.success) {
                        ...
                        for (var i in regions) {
                            ...
                            for (provider of providers) {
                                selectPV.appendChild(new Option(provider["name"] + "-" + provider[
                                    "cloud_email"] + "-" + provider["id"], provider["id"]));
                            }
        ...
        function checkFilledRows() {
            ...
            for (let key in regions) {
                ...
                if (selectPV.value !== "None" || selectCpu.value !== "None" || selectRam.value !== "None" || selectDisk
                    .value !== "None" || selectImage.value !== "None" || inputNumber.value.trim() !== "") {
                    var rowData = {
                        region: tag,
